...
class Agent:
    ...
    def __init__(self,param_set):
        ...
        self.network_syn_rate = params["network_syn_rate"]
    ...
    def run(self, is_training=True,render =False):
        ...
        if is_training :
            ...
            #copy the weight and bias vals from policy DQN ==> target
        ...
        for episode in itertools.count():
            ...
            print(f"for episode : {episode} , total rewards = {episode_reward} and epsilon = {epsilon}")
            
            if is_training:
                 #next epsilon value for next episode
            ...
            if is_training and (len(memory) > self.mini_batch_size):
                ...
                #syn the network
                if steps > self.network_syn_rate:
                    target_dqn.load_state_dict(policy_dqn.state_dict())
                    steps = 0
